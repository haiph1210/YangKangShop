...
public class RestExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
    ...
    private String getMessage(String key){
        return messageSource.getMessage(key,null,"lỗi sever", LocaleContextHolder.getLocale());
    }
    // Default exception
...
//    }
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        String detailMessage = exception.getLocalizedMessage();
        ErrorResponse errorResponse = new ErrorResponse(message, detailMessage, code);
    ...
    //đăng nhập rồi nhưng chưa có quyền
    @Override
